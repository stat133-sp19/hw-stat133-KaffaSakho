...
We can extract information about a random variable object by using methods like print(), summary() or print() 
...
We use summary.binvar() to get a comprehensive summary of our binomial object X. summary() takes as argument an object of class "binvar"
...
print.summary.binvar() prints the summary of our binomial random variable. Here print takes an object of class "summary.binvar" as input.
```{r}
print(summary)
```
...
cumulative.table
```
The output is a data frame that shows in the 2nd column the probabilities of obtaining k successes in n trials and in the 3rd column the probabilities of obtaining less or equal to k successes in n trials for any 0<k<n #change this into a math formula. This data frame has primary class "bincum".
